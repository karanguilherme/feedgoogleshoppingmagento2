...
namespace VertexNet\GoogleShopping\Model;
...
class Xmlfeed
{
     ...
     * Product Helper
     *
     * @var \VertexNet\GoogleShopping\Helper\Products
     */
    ...
    public function __construct(
        ...
        \VertexNet\GoogleShopping\Helper\Products $productFeedHelper,
    ...
    //    $parcela =  ($valor / $qtdeP);
        ...
        $xml .= $this->createNode("g:product_type", $this->_productFeedHelper->getAttributeSet($product), false);
        ...
        $xml .= $this->createNode("g:availability", 'in stock');
          ...
          $xml .= "<installment>";
          $xml .= $this->createNode('g:months',$product->getInstallments(),true);
          $xml .= $this->createNode('g:amount', number_format($valor,2,'.','').' '.$this->_productFeedHelper->getCurrentCurrencySymbol() );
          $xml .= "</installment>";



        $_condition = $product->getAttributeText('google_condiction');
